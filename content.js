const content = {
  ...
  bio: [
    "I am a research associate and PhD candidate in Economics at DIW Berlin (Socio-Economic Panel) and Free University Berlin. My research interests lie at the intersection of migration, political economy, development, and inequality. I study how new information shapes decisions in migration economics.",
    "Prior to my PhD, I worked as a Senior Data Science Consultant at Oliver Wyman and as a research assistant at the University of Mannheim (Prof. Antonio Ciccone). I hold an MSc in Econometrics and Mathematical Economics from the London School of Economics.",
  ],
  ...
  softwareAndData: [
    ...
    },
    {
      ...
      github: "https://github.com/ytchokni/econ-newsfeed",
    },
    {
      title: "pyautocausal",
      description: "Automated causal inference pipelines for data scientists and researchers.",
      github: "https://github.com/ytchokni/pyautocausal",
    },
  ],

  contact: {
    institution: "DIW Berlin — Socio-Economic Panel (SOEP)",
    address: "Anton-Wilhelm-Amo-Str. 58, 10117 Berlin, Germany",
